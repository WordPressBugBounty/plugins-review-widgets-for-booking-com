...
$stepList = [
/* translators: %s: Booking.com */
sprintf(__('Connect %s', 'review-widgets-for-booking-com'), 'Booking.com'),
__('Select Layout', 'review-widgets-for-booking-com'),
__('Select Style', 'review-widgets-for-booking-com'),
__('Set up widget', 'review-widgets-for-booking-com'),
__('Insert code', 'review-widgets-for-booking-com')
];
$stepDone = 0;
...
<p>
<?php
$advancedTab = '<a href="?page='.esc_attr($_page).'&tab=advanced#trustindex-admin">'.__('Advanced', 'review-widgets-for-booking-com').'</a>';
/* translators: %s: Advanced tab link */
echo wp_kses_post(sprintf(__("You have connected your Trustindex account, so you can find premium functionality under the %s tab. You no longer need this tab unless you choose the limited but forever free mode.", 'review-widgets-for-booking-com'), $advancedTab));
?>
</p>
</div>
<?php endif; ?>
...
<p>
<?php echo wp_kses_post(__('While downloading the reviews, we noticed that your connected page is not found.<br />If it really exists, please contact us to resolve the issue or try connect it again.', 'review-widgets-for-booking-com')); ?><br />
</p>
</div>
<?php elseif ($isReviewDownloadInProgress): ?>
<div class="ti-notice ti-notice-warning">
<p>
<?php echo esc_html(__('Your reviews are being downloaded.', 'review-widgets-for-booking-com')) . ' ' . esc_html(__('This process should only take a few minutes.', 'review-widgets-for-booking-com')); ?>
<br />
<?php echo esc_html(__('While you wait, you can start the widget setup with some review templates.', 'review-widgets-for-booking-com')); ?>
...
<?php echo esc_html(__('Manual download', 'review-widgets-for-booking-com')); ?>
...
<p>
<?php echo esc_html(__('Free plugin features are unavailable with AMP plugin.', 'review-widgets-for-booking-com')); ?>
<?php if ($pluginManagerInstance->is_trustindex_connected()): ?>
 <a href="?page=<?php echo esc_attr($_page); ?>&tab=advanced">Trustindex admin</a>
<?php else: ?>
 <a href="https://www.trustindex.io/?a=sys&c=wp-amp" target="_blank"><?php echo esc_html(__('Try premium features (like AMP) for free', 'review-widgets-for-booking-com')); ?></a>
<?php endif; ?>
</p>
...
/* translators: %s: Booking.com */
echo esc_html(sprintf(__('Connect %s', 'review-widgets-for-booking-com'), 'Booking.com'));
?></h1>
...
<a href="<?php echo esc_url(wp_nonce_url('?page='. esc_attr($_page) .'&tab=free-widget-configurator&command=delete-page', 'ti-delete-page')); ?>" class="ti-btn ti-btn-primary ti-btn-loading-on-click"><?php echo esc_html(__('Disconnect', 'review-widgets-for-booking-com')); ?></a>
</div>
<?php else: ?>
<div class="ti-box">
...
<p><?php echo esc_html(__("A popup window should be appear! Please, go to there and continue the steps! (If there is no popup window, you can check the the browser's popup blocker)", 'review-widgets-for-booking-com')); ?></p>
</div>
...
/* translators: %s: Booking.com */
$labelText = sprintf(__('%s Business URL', 'review-widgets-for-booking-com'), 'Booking.com');
$infoText = __("Type your business/company's URL and select from the list", 'review-widgets-for-booking-com');
/* translators: %s: Booking.com */
$errorText = sprintf(__('Please add your URL again: this is not a valid %s page.', 'review-widgets-for-booking-com'), "Booking.com");
$placeholder = __('e.g.:', 'review-widgets-for-booking-com') . ' ' . esc_attr($exampleUrl);
...
<a href="#" class="ti-btn"><?php echo esc_html(__('Check', 'review-widgets-for-booking-com')); ?></a>
</div>
...
<a href="#" class="ti-btn btn-connect"><?php echo esc_html(__('Connect', 'review-widgets-for-booking-com')); ?></a>
</div>
</form>
</div>
<?php endif; ?>
<h1 class="ti-header-title ti-mt-2"><?php
/* translators: %s: Booking.com reviews */
echo esc_html(sprintf(__('Check some %s widget layouts and styles', 'review-widgets-for-booking-com'), 'Booking.com reviews'));
?></h1>
<?php include(plugin_dir_path(__FILE__) . '../include/demo-widgets.php'); ?>
<?php elseif ($stepCurrent === 2): ?>
<h1 class="ti-header-title"><?php echo esc_html(__('Select Layout', 'review-widgets-for-booking-com')); ?></h1>
<?php if (!count($reviews) && !$isReviewDownloadInProgress): ?>
<div class="ti-notice ti-notice-warning" style="margin: 0 0 15px 0">
<p>
<?php
/* translators: %s: Booking.com */
echo esc_html(sprintf(__('There are no reviews on your %s platform.', 'review-widgets-for-booking-com'), 'Booking.com'));
?>
</p>
</div>
<?php endif; ?>
<div class="ti-box ti-box-filter">
<label><?php echo esc_html(__('Layout', 'review-widgets-for-booking-com')); ?>:</label>
<span class="ti-checkbox">
<input type="radio" name="layout-select" value="" data-ids="" checked>
<label><?php echo esc_html(__('All', 'review-widgets-for-booking-com')); ?></label>
</span>
...
switch ($category) {
case 'slider':
echo esc_html(__('Slider', 'review-widgets-for-booking-com'));
break;
case 'sidebar':
echo esc_html(__('Sidebar', 'review-widgets-for-booking-com'));
break;
case 'list':
echo esc_html(__('List', 'review-widgets-for-booking-com'));
break;
case 'grid':
echo esc_html(__('Grid', 'review-widgets-for-booking-com'));
break;
case 'Badge':
echo esc_html(__('Badge', 'review-widgets-for-booking-com'));
break;
case 'Button':
echo esc_html(__('Button', 'review-widgets-for-booking-com'));
break;
case 'floating':
echo esc_html(__('Floating', 'review-widgets-for-booking-com'));
break;
case 'popup':
echo esc_html(__('Popup', 'review-widgets-for-booking-com'));
break;
case 'top-rated-badge':
echo esc_html(__('Top Rated Badge', 'review-widgets-for-booking-com'));
break;
case 'fomo':
echo esc_html(__('Fomo', 'review-widgets-for-booking-com'));
break;
default:
...
<?php echo esc_html(__('Layout', 'review-widgets-for-booking-com')); ?>:
<strong><?php echo esc_html($template['name']); ?></strong>
<?php if ($template['is-popular'] || 14 === $id): ?>
<span class="ti-badge ti-most-popular-badge ti-tooltip">
<?php echo esc_html(__('Most popular', 'review-widgets-for-booking-com')); ?> <span class="dashicons dashicons-info-outline"></span>
<span class="ti-tooltip-message"><?php echo
esc_html(__('Selected by most users!', 'review-widgets-for-booking-com')).' '.
esc_html(__('This widget layout helps build trust and effectively increases sales.', 'review-widgets-for-booking-com'));
?></span>
</span>
<?php endif; ?>
<?php if (14 === $id) :?>
<a href="#" class="ti-btn ti-btn-sm ti-pull-right" style="pointer-events: none;background: grey">
<?php echo esc_html(__('Paid package feature', 'review-widgets-for-booking-com')); ?>
</a>
<?php elseif ((!$template['is-top-rated-badge'] || $isTopRatedBadgeValid) && !$fomoWidgetInvalid): ?>
<a href="<?php echo esc_url(wp_nonce_url('?page='. esc_attr($_page) .'&tab=free-widget-configurator&command=save-style&style_id='. esc_attr(urlencode($id)), 'ti-save-style')); ?>" class="ti-btn ti-btn-sm ti-btn-loading-on-click ti-pull-right"><?php echo esc_html(__('Select', 'review-widgets-for-booking-com')); ?></a>
<div class="clear"></div>
<?php endif; ?>
</div>
<div class="preview">
...
echo esc_html(sprintf(__('Our exclusive "Top Rated" badge is awarded to service providers with a rating of %s and above.', 'review-widgets-for-booking-com'), $pluginManager::$topRatedMinimumScore));
?><br />
</p>
</div>
<?php endif; ?>
...
<div class="ti-notice ti-notice-info" style="margin: 0 0 15px 0">
<p>
<?php echo esc_html(__('Update your reviews to use this widget.', 'review-widgets-for-booking-com')); ?><br />
</p>
</div>
<?php endif; ?>
...
<h1 class="ti-header-title"><?php echo esc_html(__('Select Style', 'review-widgets-for-booking-com')); ?></h1>
<?php if (!count($reviews) && !$isReviewDownloadInProgress): ?>
<div class="ti-notice ti-notice-warning" style="margin: 0 0 15px 0">
<p>
<?php
...
<div class="ti-box-inner">
<div class="ti-box-header ti-box-header-normal">
<?php echo esc_html(__('Style', 'review-widgets-for-booking-com')); ?>:
...
<span class="ti-tooltip-message"><?php echo
esc_html(__('Selected by most users!', 'review-widgets-for-booking-com')).' '.
esc_html(__('This widget style helps build trust and effectively increases sales.', 'review-widgets-for-booking-com'));
?></span>
</span>
<?php endif; ?>
<a href="<?php echo esc_url(wp_nonce_url('?page='. esc_attr($_page) .'&tab=free-widget-configurator&command=save-set&set_id='. esc_attr(urlencode($id)), 'ti-save-set')); ?>" class="ti-btn ti-btn-sm ti-btn-loading-on-click ti-pull-right"><?php echo esc_html(__('Select', 'review-widgets-for-booking-com')); ?></a>
<div class="clear"></div>
</div>
<div class="preview">
...
-
<?php echo esc_html(__('with Trustindex verified', 'review-widgets-for-booking-com')); ?>
</strong>
...
<a href="<?php echo esc_url(wp_nonce_url('?page='. esc_attr($_page) .'&tab=free-widget-configurator&command=save-set&set_id='. esc_attr(urlencode($id)), 'ti-save-set')); ?>&verified_by_trustindex" class="ti-btn ti-btn-sm ti-btn-loading-on-click ti-pull-right"><?php echo esc_html(__('Select', 'review-widgets-for-booking-com')); ?></a>
<div class="clear"></div>
</div>
<div class="preview">
...
<p>
<span class="dashicons dashicons-star-empty"></span> <strong><?php echo esc_html(__('Congratulations!', 'review-widgets-for-booking-com')); ?></strong><br />
<?php
/* translators: 1: 5, 2: 4.5, 3: 12 */
echo esc_html(sprintf(__('Our system ranked you in the top %1$d%% of companies based on your reviews. Your total rating score above %2$s in the last %3$d month, and your reviews are genuine', 'review-widgets-for-booking-com'), 5, $pluginManager::$topRatedMinimumScore, 12));
?><br />
<?php echo wp_kses_post(__('This allows you to <strong>use in the widgets the Trustindex verified badge, the Universal Symbol of Trust.</strong> With the verified badge you can build more trust, and sell more!', 'review-widgets-for-booking-com')); ?>
</p>
</div>
</div>
</div>
...
<h1 class="ti-header-title"><?php echo esc_html(__('Set up widget', 'review-widgets-for-booking-com')); ?></h1>
<?php if (!count($reviews) && !$isReviewDownloadInProgress): ?>
<div class="ti-notice ti-notice-warning" style="margin: 0 0 15px 0">
<p>
<?php
...
echo esc_html(sprintf(__('Our exclusive "Top Rated" badge is awarded to service providers with a rating of %s and above.', 'review-widgets-for-booking-com'), $pluginManager::$topRatedMinimumScore));
?><br />
<a href="?page=<?php echo esc_attr($_page); ?>&tab=free-widget-configurator&step=2" class="ti-btn ti-btn-sm ti-btn-loading-on-click" style="margin-top: 10px"><?php echo esc_html(__('Please select another widget', 'review-widgets-for-booking-com')); ?></a>
</p>
</div>
<?php endif; ?>
<div class="ti-preview-boxes-container">
...
<?php echo esc_html(__('Widget Preview', 'review-widgets-for-booking-com')); ?>
...
<div class="ti-box">
<div class="ti-box-inner">
<div class="ti-box-header"><?php echo esc_html(__('Widget Settings', 'review-widgets-for-booking-com')); ?></div>
...
<label>
<?php echo esc_html(__('Verified by Trustindex', 'review-widgets-for-booking-com')); ?>
<span class="ti-badge ti-badge-info"><?php echo esc_html(__('Recommended', 'review-widgets-for-booking-com')); ?></span>
</label>
...
<option value="0"<?php if (!$verifiedByTrustindex): ?> selected<?php endif; ?>><?php echo esc_html(__('Hide', 'review-widgets-for-booking-com')); ?></option>
<option value="1"<?php if ($verifiedByTrustindex === 1): ?> selected<?php endif; ?>><?php echo
/* translators: %d: 1 */
esc_html(sprintf(__('Style %d', 'review-widgets-for-booking-com'), 1));
?></option>
<option value="2"<?php if ($verifiedByTrustindex === 2): ?> selected<?php endif; ?>><?php
/* translators: %d: 2 */
echo esc_html(sprintf(__('Style %d', 'review-widgets-for-booking-com'), 2));
?></option>
</select>
</form>
</div>
...
<div class="ti-form-group">
<label><?php echo esc_html(__('Filter your ratings', 'review-widgets-for-booking-com')); ?></label>
...
<option value="1,2,3,4,5"<?php if (count($filter['stars']) > 2): ?> selected<?php endif; ?>><?php echo esc_html(__('Show all', 'review-widgets-for-booking-com')); ?></option>
...
<option value="5"<?php if (count($filter['stars']) === 1): ?> selected<?php endif; ?>><?php echo esc_html(__('only', 'review-widgets-for-booking-com')); ?> &starf;&starf;&starf;&starf;&starf;</option>
</select>
</form>
</div>
<?php endif; ?>
<div class="ti-form-group">
<label><?php echo esc_html(__('Select language', 'review-widgets-for-booking-com')); ?></label>
<form method="post" action="">
...
<?php if ($pluginManagerInstance->isLayoutHasReviews()): ?>
<div class="ti-form-group">
<label><?php echo esc_html(__('Select date format', 'review-widgets-for-booking-com')); ?></label>
<form method="post" action="">
...
break;
case 'hide':
echo esc_html(__('Hide', 'review-widgets-for-booking-com'));
break;
default:
...
<div class="ti-form-group">
<label><?php echo esc_html(__('Select name format', 'review-widgets-for-booking-com')); ?></label>
<form method="post" action="">
...
<?php
if (1 === (int)$format['id']) {
echo esc_html(__('Do not format', 'review-widgets-for-booking-com'));
} else {
...
<?php if (!in_array($styleId, [17, 21, 52, 53, 112, 114])): ?>
<div class="ti-form-group">
<label><?php echo esc_html(__('Align', 'review-widgets-for-booking-com')); ?></label>
<form method="post" action="">
<input type="hidden" name="command" value="save-align" />
<?php wp_nonce_field('ti-save-align'); ?>
<select class="ti-form-control" name="align">
<option value="left" <?php echo $pluginManagerInstance->getWidgetOption('align') === 'left' ? 'selected' : ''; ?>><?php echo esc_html(__('left', 'review-widgets-for-booking-com')); ?></option>
<option value="center" <?php echo $pluginManagerInstance->getWidgetOption('align') === 'center' ? 'selected' : ''; ?>><?php echo esc_html(__('center', 'review-widgets-for-booking-com')); ?></option>
<option value="right" <?php echo $pluginManagerInstance->getWidgetOption('align') === 'right' ? 'selected' : ''; ?>><?php echo esc_html(__('right', 'review-widgets-for-booking-com')); ?></option>
<option value="justify" <?php echo $pluginManagerInstance->getWidgetOption('align') === 'justify' ? 'selected' : ''; ?>><?php echo esc_html(__('justify', 'review-widgets-for-booking-com')); ?></option>
</select>
</form>
</div>
<div class="ti-form-group">
<label><?php echo esc_html(__('Review text', 'review-widgets-for-booking-com')); ?></label>
<form method="post" action="">
...
<option value="scroll" <?php echo $pluginManagerInstance->getWidgetOption('review-text-mode') === 'scroll' ? 'selected' : ''; ?>><?php echo esc_html(__('Scroll', 'review-widgets-for-booking-com')); ?></option>
<option value="readmore" <?php echo $pluginManagerInstance->getWidgetOption('review-text-mode') === 'readmore' ? 'selected' : ''; ?>><?php echo esc_html(__('Read more', 'review-widgets-for-booking-com')); ?></option>
<option value="truncated" <?php echo $pluginManagerInstance->getWidgetOption('review-text-mode') === 'truncated' ? 'selected' : ''; ?>><?php echo esc_html(__('Truncated', 'review-widgets-for-booking-com')); ?></option>
</select>
</form>
</div>
<?php endif; ?>
...
<div class="ti-form-group">
<label><?php echo esc_html(__('Select type', 'review-widgets-for-booking-com')); ?></label>
<form method="post" action="">
...
switch ($type) {
case 'Apartment':
echo esc_html(__('Apartment', 'review-widgets-for-booking-com'));
break;
case 'Bar':
echo esc_html(__('Bar', 'review-widgets-for-booking-com'));
break;
case 'Cafe':
echo esc_html(__('Cafe', 'review-widgets-for-booking-com'));
break;
case 'Clinic':
echo esc_html(__('Clinic', 'review-widgets-for-booking-com'));
break;
case 'Hotel':
echo esc_html(__('Hotel', 'review-widgets-for-booking-com'));
break;
case 'Provider':
echo esc_html(__('Provider', 'review-widgets-for-booking-com'));
break;
case 'Restaurant':
echo esc_html(__('Restaurant', 'review-widgets-for-booking-com'));
break;
case 'Service':
echo esc_html(__('Service', 'review-widgets-for-booking-com'));
break;
case 'Webshop':
echo esc_html(__('Webshop', 'review-widgets-for-booking-com'));
break;
default:
echo esc_html($type);
break;
...
<option value="hide"<?php if ($topRatedDate === 'hide'): ?> selected<?php endif; ?>><?php echo esc_html(__("Hide", 'review-widgets-for-booking-com')); ?></option>
<option value="last-year"<?php if ($topRatedDate === 'last-year'): ?> selected<?php endif; ?>><?php echo esc_html(__("Last year", 'review-widgets-for-booking-com')); ?></option>
<option value=""<?php if (!$topRatedDate): ?> selected<?php endif; ?>><?php echo esc_html(__("Current year", 'review-widgets-for-booking-com')); ?></option>
</select>
</form>
</div>
<?php endif; ?>
...
<label><?php echo esc_html(__('Title', 'review-widgets-for-booking-com')); ?></label>
<form method="post" action="">
...
<small class="ti-text-muted" style="padding-left: 5px"><?php echo esc_html(htmlentities(__('Enclose the text in <u></u> if you want to highlight it', 'review-widgets-for-booking-com'))); ?></small>
</form>
</div>
<div class="ti-form-group" style="max-width: 400px">
<label><?php echo esc_html(__('Subtitle', 'review-widgets-for-booking-com')); ?></label>
<form method="post" action="">
...
<option value="hide" <?php echo $pluginManagerInstance->getWidgetOption('fomo-text') === '' ? 'selected' : ''; ?>><?php echo esc_html(__('Hide', 'review-widgets-for-booking-com')); ?></option>
...
<div class="ti-form-group">
<label><?php echo esc_html(__('Icon', 'review-widgets-for-booking-com')); ?></label>
<form method="post" action="">
...
<option value="hide" <?php echo $pluginManagerInstance->getWidgetOption('fomo-icon') === 'hide' ? 'selected' : ''; ?>><?php echo esc_html(__('Hide', 'review-widgets-for-booking-com')); ?></option>
...
switch ($icon) {
case 'profile-images':
echo esc_html(__('Profile images', 'review-widgets-for-booking-com'));
break;
case 'platform':
echo esc_html(__('Platform', 'review-widgets-for-booking-com'));
break;
default:
...
<div class="ti-form-group">
<label><?php echo esc_html(__('Color', 'review-widgets-for-booking-com')); ?></label>
<form method="post" action="">
...
<div class="ti-form-group">
<label><?php echo esc_html(__('Margin', 'review-widgets-for-booking-com')); ?></label>
<form method="post" action="">
...
<div class="ti-form-group">
<label><?php echo esc_html(__('Number of days', 'review-widgets-for-booking-com')); ?></label>
<form method="post" action="">
...
$name = sprintf(__('%d days', 'review-widgets-for-booking-com'), $day);
if ($day === 1) {
/* translators: %d: 24 */
$name = sprintf(__('%d hours', 'review-widgets-for-booking-com'), 24);
}
?>
...
<div class="ti-form-group">
<label><?php echo esc_html(__('Hide until count reaches', 'review-widgets-for-booking-com')); ?></label>
<form method="post" action="">
...
<label><?php echo esc_html(__('Hide reviews without comments', 'review-widgets-for-booking-com')); ?></label>
</span>
<?php endif; ?>
...
<label><?php echo esc_html(__('Hide rating text', 'review-widgets-for-booking-com')); ?></label>
</span>
<?php endif; ?>
...
<label><?php echo esc_html(__('Show minimum review filter condition', 'review-widgets-for-booking-com')); ?></label>
</span>
<?php endif; ?>
<?php if ($pluginManagerInstance->isLayoutHasReviews()): ?>
<span class="ti-checkbox ti-checkbox-row">
...
<label><?php echo esc_html(__('Show review reply', 'review-widgets-for-booking-com')); ?></label>
</span>
<?php endif; ?>
...
<label><?php echo esc_html(__('Show write review button', 'review-widgets-for-booking-com')); ?></label>
</span>
<?php endif; ?>
...
<label><?php echo esc_html(__('Show "Load more" button', 'review-widgets-for-booking-com')); ?></label>
</span>
<?php endif; ?>
...
<label><?php echo esc_html(__('Show verified review icon', 'review-widgets-for-booking-com')); ?></label>
</span>
<?php endif; ?>
...
<label><?php echo esc_html(__('Show navigation arrows', 'review-widgets-for-booking-com')); ?></label>
</span>
<?php endif; ?>
...
<label><?php echo esc_html(__("Show reviewer's profile picture", 'review-widgets-for-booking-com')); ?></label>
</span>
<span class="ti-checkbox ti-checkbox-row ti-disabled">
<input type="checkbox" value="1" disabled />
<label class="ti-tooltip">
<?php echo esc_html(__("Show reviewer's profile picture locally, from a single image (less requests)", 'review-widgets-for-booking-com')); ?>
<span class="ti-tooltip-message"><?php echo esc_html(__('Paid package feature', 'review-widgets-for-booking-com')); ?></span>
</label>
</span>
<span class="ti-checkbox ti-checkbox-row ti-disabled">
<input type="checkbox" value="1" disabled />
<label class="ti-tooltip">
<?php echo esc_html(__('Show photos in reviews', 'review-widgets-for-booking-com')); ?>
<span class="ti-tooltip-message"><?php echo esc_html(__('Paid package feature', 'review-widgets-for-booking-com')); ?></span>
</label>
</span>
<?php endif; ?>
...
<label><?php echo esc_html(__('Enable mouseover animation', 'review-widgets-for-booking-com')); ?></label>
</span>
<?php endif; ?>
<?php if (!$pluginManagerInstance->isFomoWidget()): ?>
<span class="ti-checkbox ti-checkbox-row">
...
<label><?php echo esc_html(__("Use site's font", 'review-widgets-for-booking-com')); ?></label>
</span>
<?php endif; ?>
<?php if ($pluginManagerInstance->isLayoutHasReviews()): ?>
<span class="ti-checkbox ti-checkbox-row">
<input type="checkbox" name="show-logos" value="1"<?php if ($pluginManagerInstance->getWidgetOption('show-logos')): ?> checked<?php endif;?> />
<label><?php echo esc_html(__('Show platform logos', 'review-widgets-for-booking-com')); ?></label>
</span>

<span class="ti-checkbox ti-checkbox-row">
<input type="checkbox" name="show-stars" value="1"<?php if ($pluginManagerInstance->getWidgetOption('show-stars')): ?> checked<?php endif;?> />
<label><?php echo esc_html(__('Show platform stars', 'review-widgets-for-booking-com')); ?></label>
</span>
<?php endif; ?>
<?php if ($pluginManagerInstance->isFomoWidget()): ?>
...
<label><?php echo esc_html(__('Default open', 'review-widgets-for-booking-com')); ?></label>
</span>
<?php endif; ?>
<span class="ti-checkbox ti-checkbox-row">
<input type="checkbox" name="fomo-border" value="1"<?php if ($pluginManagerInstance->getWidgetOption('fomo-border')): ?> checked<?php endif; ?> />
<label><?php echo esc_html(__('Show border', 'review-widgets-for-booking-com')); ?></label>
</span>
...
<label><?php echo esc_html(__('Show icon background', 'review-widgets-for-booking-com')); ?></label>
</span>
<?php endif; ?>
<span class="ti-checkbox ti-checkbox-row">
<input type="checkbox" name="fomo-link" value="1"<?php if ($pluginManagerInstance->getWidgetOption('fomo-link')): ?> checked<?php endif; ?> />
<label><?php echo esc_html(__('Enable link', 'review-widgets-for-booking-com')); ?></label>
</span>
...
<label><?php echo esc_html(__('Show arrow', 'review-widgets-for-booking-com')); ?></label>
</span>
<?php endif; ?>
<?php endif; ?>
</form>
...
<a href="<?php echo esc_url(wp_nonce_url('?page='. esc_attr($_page) .'&tab=free-widget-configurator&setup_widget', 'ti-setup-widget')); ?>" class="ti-btn ti-btn-loading-on-click ti-pull-right"><?php echo esc_html(__('Save and get code', 'review-widgets-for-booking-com')); ?></a>
<div class="clear"></div>
</div>
<?php endif; ?>
</div>
...
<?php else: ?>
<h1 class="ti-header-title"><?php echo esc_html(__('Insert code', 'review-widgets-for-booking-com')); ?></h1>
<?php if (!count($reviews) && !$isReviewDownloadInProgress): ?>
<div class="ti-notice ti-notice-warning" style="margin: 0 0 15px 0">
<p>
<?php
...
<?php endif; ?>
<div class="ti-box">
<div class="ti-box-header"><?php echo esc_html(__('Insert this shortcode into your website', 'review-widgets-for-booking-com')); ?></div>
...
esc_html(sprintf(__('%1$d Professional Review Widgets That Help Boost Sales by %2$d%%', 'review-widgets-for-booking-com'), 5, 9));
?>
<small>
<?php echo
/* translators: %d: widget count */
esc_html(sprintf(__('For best results, generate all %d widgets and place them in the recommended positions.', 'review-widgets-for-booking-com'), 5));
?>
</small>
<?php echo wp_kses_post($pluginManagerInstance->getProFeatureButton('wp-booking-'.(!class_exists('Woocommerce') ? 6 : 7))); ?>
</div>
<?php
$tiSalesRows = [
[
'Button VIII.',
__('Homepage – Hero section', 'review-widgets-for-booking-com'),
__('Reduces bounce rate', 'review-widgets-for-booking-com'),
$pluginManagerInstance->get_plugin_file_url('static/img/ti-widget-tooltip-button8.png'),
300,
],
[
'Slider I. <i>('.__('with header', 'review-widgets-for-booking-com').')</i>',
__('Homepage – Middle of the page', 'review-widgets-for-booking-com'),
__('Increases time on site, improves SEO, more sales', 'review-widgets-for-booking-com'),
$pluginManagerInstance->get_plugin_file_url('static/img/ti-widget-tooltip-slider1-with-header.png'),
1200,
],
[
'Top Rated Badge VIII.',
__('Homepage – Footer', 'review-widgets-for-booking-com'),
__('More calls and emails', 'review-widgets-for-booking-com'),
$pluginManagerInstance->get_plugin_file_url('static/img/ti-widget-tooltip-top-rated-badge8.png'),
300,
],
[
'Button III.',
__('Contact page - Under the contact form', 'review-widgets-for-booking-com'),
__('More enquires', 'review-widgets-for-booking-com'),
$pluginManagerInstance->get_plugin_file_url('static/img/ti-widget-tooltip-button3.png'),
300,
],
[
__('Review Certificate', 'review-widgets-for-booking-com'),
__('Every page – Left corner of the page', 'review-widgets-for-booking-com'),
__('Builds trust', 'review-widgets-for-booking-com'),
...
[
'Button III.',
__('Every product page – Near price or cart button', 'review-widgets-for-booking-com'),
__('Increases purchases', 'review-widgets-for-booking-com'),
$pluginManagerInstance->get_plugin_file_url('static/img/ti-widget-tooltip-button3.png'),
300,
],
[
'Slider I. <i>('.__('with footer', 'review-widgets-for-booking-com').')</i>',
__('Every product page – Below the product details', 'review-widgets-for-booking-com'),
__('Builds purchase confidence before checkout', 'review-widgets-for-booking-com'),
...
<div><?php echo esc_html(__('Recommended widget', 'review-widgets-for-booking-com')); ?></div>
<div><?php echo esc_html(__('Where to place it', 'review-widgets-for-booking-com')); ?></div>
<div><?php echo esc_html(__('Main benefit', 'review-widgets-for-booking-com')); ?></div>
</div>
...
<strong><?php
/* translators: %d: 9 */
echo esc_html(sprintf(__('Recommended setup for +%d%% more sales', 'review-widgets-for-booking-com'), 9));
?></strong>
<span><?php
/* translators: %s: 35,000+ */
echo esc_html(sprintf(__('Based on data from %s businesses.', 'review-widgets-for-booking-com'), '35,000+'));
?></span>
</div>
</div>
</div>
